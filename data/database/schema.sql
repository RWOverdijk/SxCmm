...
CREATE TABLE component_setting (id INT AUTO_INCREMENT NOT NULL, component_id INT DEFAULT NULL, setting_key VARCHAR(200) NOT NULL, locale VARCHAR(30) DEFAULT NULL, setting_value LONGTEXT NOT NULL, INDEX IDX_2F7839B1E2ABAFFF (component_id), INDEX key_idx (setting_key), UNIQUE INDEX setting_unique (component_id, setting_key, locale), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;
